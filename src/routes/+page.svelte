...
<section class="hero">
  <div class="wrap">
    ...
    <h1 class="heading-xl reveal d1">
      สร้าง<span class="hero-highlight">ตู้ขาย Digital Product</span><br>ของเราเองภายใน 1 วัน
    </h1>
    ...
    <p class="sub-guarantee reveal d3">(ปล. สร้างเสร็จแล้ว <strong>ใช้ฟรีตลอดชีพ</strong> <u>ไม่ต้องเสียรายเดือน</u>เลย)</p>
...
<section>
  <div class="wrap">
    ...
    <div class="story-body">
      <p class="reveal">ถ้าคุณกำลังหาอะไรบางอย่างที่ใช้เวลาแค่ <strong>1 วัน</strong>ในการทำ</p>
      <p class="reveal">และสามารถเป็นพื้นฐานของการสร้างรายได้เสริม<strong>หลักหมื่นถึงหลักแสน</strong>ต่อเดือนได้...</p>
    ...
    <p><strong>คุณมาถูกที่แล้ว</strong> เดี๋ยวผมเล่าให้ฟัง</p>
      ...
      <p>"ทำยังไงให้มีรายได้เพิ่ม โดย<strong>ไม่ต้องเอาเวลาของเราไปแลก</strong>นะ?"</p>
      ...
      <p class="reveal">คอยอธิบายสินค้า <strong>ถ้าตอบช้าลูกค้าก็หายอีก</strong></p>

      <div class="img-slot reveal">
        <img src="/ovm/customer-needs.png" alt="ภาพแสดงความต้องการของลูกค้าที่ลดลงเมื่อเวลาผ่านไป" />
      </div>

      <p class="reveal">จนวันนึงผมเริ่มตั้งคำถามใหม่ว่า…</p>

      <p>"ถ้าเราทำเหมือน<strong>ตู้ขายของอัตโนมัติ</strong>แต่มาอยู่บนโลกออนไลน์ได้ไหมนะ?"</p>

      <p class="reveal">เจ้าของเต่าบินไม่เคยต้องอยู่ตรงนั้นเลย แต่ก็ยังขายน้ำได้</p>
      <p class="reveal">เราทำแบบนั้นบนออนไลน์มั่งได้มั้ย</p>

      <div class="img-slot reveal">
        <img src="/ovm/online-vending-machine.png" alt="ภาพเปรียบเทียบตู้ขายของจริงกับตู้ขายของออนไลน์" />
      </div>

      <p class="reveal">ผมเริ่มศึกษาการสร้าง<strong>ระบบขายแบบอัตโนมัติ</strong></p>
      <p class="reveal">ด้วยความที่ไม่ได้มาสายเทค เลยลองทำผิดๆ ถูกๆ อยู่เป็นปี</p>
      ...
      <p class="reveal">ผมได้ลาออกเพื่อมาใช้<strong>ชีวิตแบบที่เคยฝันไว้</strong>เลย</p>
      ...
      <p class="reveal">มันจะ<strong>ง่ายขึ้นเยอะ</strong>เลยถ้าเราไม่มีค่าใช้จ่ายตามมากดดัน</p>
      <p class="reveal">และระบบตู้ขายสินค้าออนไลน์ที่เราจะสร้างกันนี้</p>
      <p class="reveal"><u><strong>ไม่มีค่าใช้จ่ายรายเดือนเลยซักบาท</strong></u></p>
      <p class="reveal">มันจะซื้อเวลาให้เราได้<strong>ลองโน่นลองนี่เต็มที่</strong>เลย</p>
      <p class="reveal">และถ้าคุณมีของขายอยู่แล้ว แต่ขายทาง Platform อื่นอยู่</p>
      <p class="reveal">โห...<u><strong>ยิ่งเหมาะเลย</strong></u></p>
      <p class="reveal">เพราะนี่จะเป็นพื้นที่ของคุณจริงๆ ชอบดีไซน์แบบไหน แต่งเองได้เลย</p>
      <p class="reveal"><strong>บ่งบอกความเป็นเราได้เต็มที่</strong></p>
      <p class="reveal">และที่สำคัญที่สุด มันจะ<strong>ไม่มีใครสามารถปิดร้านคุณได้</strong></p>

      <br/>

      <p class="reveal">ถ้าคุณเป็นคนที่:<br>
        → อยากเปลี่ยน<strong>ความรู้ในหัวเป็นเงิน</strong><br>
        → อยากมี<strong>พื้นที่ขายสินค้าออนไลน์ของตัวเอง</strong><br>
        → อยากรู้ว่า<strong>การตื่นมาแล้วมีแจ้งเตือนเงินเข้ามันรู้สึกยังไง</strong><br>
    ...
    <div class="offer-list">
      ...
      <div class="offer-card reveal">
        <div>
          ...
          <ul class="offer-feats">
            ...
            <li>คำถาม หรือ อะไรที่อยากทำได้แล้วรีเควสเยอะ ผม Update ในคอร์สให้</li>
          </ul>
        </div>
        <div class="offer-price">
      ...
      <div class="offer-card reveal">
        <div>
          ...
          <ul class="offer-feats">
            <li>ไม่มีไอเดีย ไม่ต้องกลัวเริ่มไม่ถูกค้าบ เริ่มจาก Template ได้เลย</li>
            <li>หน้าขายของ เว็บบริษัท เว็บส่วนตัว ผมชี้แหล่งโหลด Template ฟรีเพียบ</li>
            <li>ผม Template เว็บที่ยอดขายหลักล้านมาแกะให้ดูด้วย ลอกไปใช้ได้เลย</li>
          </ul>
        </div>
        <div class="offer-price">
...
<section class="alt">
  <div class="wrap">
    <div class="guarantee-inner reveal">
      ...
      <p>
        ถ้าคุณอ่านมาถึงตรงนี้ ผมว่าคุณสนใจจริงๆ แหละ แต่อาจจะไม่มั่นใจว่าจะทำได้จริงไหม
        <br/><br/>
        ผมสัญญาแบบนี้ครับ
        <br/><br/>
        ภายใน 14 วันถ้าคุณนั่งเรียน OVM และคุณรู้สึกว่าทำไม่ได้จริงๆ เรียนไปทั้งหมดแล้ว มันยากไป คุณยังไม่มีร้านของตัวเอง ผมไม่อยากได้เงินคุณเลยถ้าผมส่งมอบสิ่งที่สัญญาไว้ไม่ได้ ฉะนั้นไม่ต้องกลัวครับ ทักเข้ามาหาผมได้เลยครับ ผมยินดีคืนเงินให้ 100% แบบไม่โกรธกันเลย :)
      </p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="faq-list reveal">
      ...
      <div class="faq-item">
        ...
        <div class="faq-a">
          <div class="faq-a-inner">ได้แน่นอนครับ คอร์สนี้ออกแบบมาสำหรับคนที่ไม่มีพื้นฐานเทคนิคโดยเฉพาะ สอนแบบจับมือทำทุกขั้นตอน ทำตามได้เลยทันที ไม่ต้องมีความรู้ด้านเทคนิคใดๆ มาก่อนเลย</div>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-a">
          <div class="faq-a-inner">ไม่ต้องเขียนโค้ดเลยครับ! คอร์สนี้ใช้ AI ช่วยทำงานแทน เน้นให้คุณสร้างระบบขายได้จริงโดยไม่ต้องงมเรื่องโปรแกรมมิ่งเลยแม้แต่บรรทัดเดียว</div>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-a">
          <div class="faq-a-inner">แนะนำให้ใช้คอมพิวเตอร์หรือแล็ปท็อปครับ เพราะการสร้างเว็บไซต์และตั้งค่าระบบต่างๆ จะทำได้สะดวกกว่ามาก สเปคปกติทั่วไปก็เพียงพอแล้ว ไม่ต้องซื้อใหม่เลย</div>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-a">
          <div class="faq-a-inner">ถูกกฎหมาย 100% ครับ ทุกเครื่องมือที่ใช้ในคอร์สเป็น Freemium หรือ Open Source ที่ให้ใช้ฟรีอย่างถูกต้อง ไม่มีการแคร็กหรือละเมิดลิขสิทธิ์ใดๆ ทั้งสิ้น</div>
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-a">
          <div class="faq-a-inner">เหมาะมากครับ คอร์สมี Website Template สำเร็จรูปให้เลือกใช้ได้เลย ไม่ต้องออกแบบเอง แค่เลือก Template ที่ชอบแล้วใส่เนื้อหาของคุณลงไป เว็บก็ออกมาดูดีแบบมืออาชีพทันที</div>
        </div>
      </div>
...
<section class="final-cta">
  <div class="wrap">
    ...
    <p class="body-lg reveal d2">ขอเวลา 1 แค่วัน ผมจะช่วยคุณเปิดร้านพร้อมขายเลย</p>
    <div class="reveal d3">
      <a href="#early-bird" class="btn btn--lg">พร้อมลุยแล้ว</a>
    </div>
  </div>
...
<section class="member-login">
  <div class="wrap">
    <p class="member-login-text">
      เป็นสมาชิกอยู่แล้ว?
      <a href="/login" data-sveltekit-preload-data="tap" class="member-login-link">เข้าสู่ระบบที่นี่</a>
    </p>
  </div>
</section>
...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .heading-xl {
      ...
      font-weight: 700;
      line-height: 1.25;
      letter-spacing: .005em;  /* Thai: keep near-zero */
    }
    ...
    .btn {
      ...
      box-shadow: 0 2px 20px rgba(201,126,20,.3), 0 1px 0 rgba(255,255,255,.1) inset;
      letter-spacing: .02em;
    }
    .btn:hover  { background: var(--accent-hover); transform: translateY(-2px); box-shadow: 0 8px 32px rgba(201,126,20,.4); }
    .btn:active { transform: none; }
    .btn--lg    { font-size: 17px; padding: 15px 52px; }
    ...
    .hero {
      padding: 56px 0 40px;
      text-align: center;
      background: radial-gradient(ellipse 900px 500px at 50% -60px, rgba(201,126,20,.06) 0%, transparent 100%);
    }

    /* Hero-specific type overrides — smaller to fit above the fold */
    .hero .eyebrow        { margin-bottom: 10px; }
    .hero .heading-xl     { max-width: 720px; margin: 0 auto 16px; font-size: clamp(24px, 3.6vw, 44px); }
    .hero .body-lg        { max-width: 600px; margin: 0 auto 10px; font-size: clamp(15px, 1.5vw, 17px); line-height: 1.75; }
    .hero-highlight {
      position: relative;
      display: inline-block;
      padding: 0 .1em;
    ...
    .sub-guarantee strong { color: var(--black); font-weight: 600; }
    .sub-guarantee u { text-underline-offset: 3px; }
    ...
    .t-card {
      ...
      box-shadow: 0 1px 0 var(--gray-border), 0 4px 20px rgba(0,0,0,.05);
      transition: box-shadow .28s, transform .28s;
    }
    .t-card:hover {
      box-shadow: 0 1px 0 var(--gray-border), 0 10px 40px rgba(0,0,0,.09);
      transform: translateY(-3px);
    }

    .t-stars { display: flex; gap: 2px; margin-bottom: 12px; }
    .t-stars { color: var(--accent); font-size: 13px; letter-spacing: .05em; }
    ...
    .section-header .heading-lg { margin-bottom: 0; }
    ...
    .callout {
      ...
      border-radius: 14px;
      border: 1px solid rgba(201,126,20,.18);
      padding: 24px 32px;
      margin: 40px 0;
    }
    ...
    /* ─── ══════════════════════════════════
         WHAT YOU GET
    ══════════════════════════════════ ─── */
    .offer-list { display: flex; flex-direction: column; gap: 16px; margin-bottom: 64px; }
    ...
    .offer-card:hover {
      border-color: rgba(201,126,20,.4);
      box-shadow: 0 6px 32px rgba(201,126,20,.07);
      transform: translateY(-1px);
    }
    .offer-card.dark  { background: var(--black); border-color: var(--black); }
    .offer-card.dark:hover { border-color: #333; box-shadow: 0 6px 32px rgba(0,0,0,.25); transform: translateY(-1px); }
    ...
    .offer-badge {
      ...
      border: 1px solid rgba(201,126,20,.2);
    }
    .offer-card.dark .offer-badge { background: rgba(201,126,20,.15); border-color: rgba(201,126,20,.25); }

    .offer-title { font-size: 19px; font-weight: 700; color: var(--black); margin-bottom: 18px; line-height: 1.4; }
    .offer-card.dark .offer-title { color: #fff; }

    .offer-feats { list-style: none; display: flex; flex-direction: column; gap: 10px; }
    .offer-feats li { font-size: 15px; color: var(--gray-dark); padding-left: 22px; position: relative; line-height: 1.7; }
    .offer-feats li::before { content: '✓'; position: absolute; left: 0; color: var(--accent); font-weight: 700; }
    .offer-card.dark .offer-feats li { color: #A09E96; }
    .offer-card.dark .offer-feats li::before { color: var(--accent); }

    .offer-price { text-align: right; flex-shrink: 0; }
    .offer-price .strike { font-size: 12.5px; color: var(--gray-light); text-decoration: line-through; display: block; margin-bottom: 4px; }
    .offer-price .val    { font-size: 17px; font-weight: 700; color: var(--black); }
    .offer-card.dark .offer-price .val { color: var(--accent); }
    ...
    .price-original { font-size: 15px; color: var(--gray-light); margin-bottom: 6px; }
    .price-original span { text-decoration: line-through; }

    .price-row {
      display: flex; align-items: baseline; justify-content: center; gap: 12px;
      margin-bottom: 8px;
    }
    .price-row .label  { font-size: 18px; font-weight: 500; color: rgba(255,255,255,.6); }
    .price-row .amount { font-size: 72px; font-weight: 700; color: #fff; line-height: 1; letter-spacing: -.01em; }
    .price-row .unit   { font-size: 18px; font-weight: 400; color: rgba(255,255,255,.5); }

    .price-note { font-size: 14.5px; color: var(--gray-light); margin-bottom: 36px; line-height: 1.85; }
    ...
    .special-bonus .eyebrow { color: var(--accent); }
    .special-bonus .heading-md { color: #fff; margin-bottom: 20px; margin-top: 8px; }
    .sb-list { list-style: none; display: flex; flex-direction: column; gap: 10px; }
    .sb-list li { font-size: 15px; color: #A09E96; padding-left: 22px; position: relative; line-height: 1.75; }
    .sb-list li::before { content: '→'; position: absolute; left: 0; color: var(--accent); }
    ...
    .guarantee-inner .heading-lg { margin-bottom: 20px; }
    .guarantee-inner p { font-size: 16.5px; color: var(--gray-dark); line-height: 2.05; }
    ...
    .faq-icon svg { width: 13px; height: 13px; stroke: var(--gray-mid); transition: stroke .22s; }
    :global(.faq-item.open .faq-icon) { background: var(--accent); border-color: var(--accent); transform: rotate(45deg); }
    :global(.faq-item.open .faq-icon svg) { stroke: #fff; }

    .faq-a { max-height: 0; overflow: hidden; transition: max-height .4s ease; }
    :global(.faq-item.open .faq-a) { max-height: 320px; }
    .faq-a-inner { padding-bottom: 24px; font-size: 15.5px; color: var(--gray-mid); line-height: 2; }

    /* ─── ══════════════════════════════════
         FINAL CTA + FOOTER
    ══════════════════════════════════ ─── */
    .final-cta { text-align: center; padding: 80px 0 140px; }
    .final-cta .heading-lg { margin-bottom: 14px; }
    .final-cta .body-lg    { max-width: 460px; margin: 0 auto 44px; }
    ...
    @media (max-width: 780px) {
      ...
      .hero .heading-xl { font-size: 28.8px; }
      .t-grid-3, .t-grid-2 { grid-template-columns: 1fr; }
      .offer-card { grid-template-columns: 1fr; gap: 20px; padding: 28px 24px; }
      .offer-price { text-align: left; }
      .price-box { padding: 44px 28px; }
      .price-row .amount { font-size: 56px; }
      .special-bonus { padding: 28px 24px; }
    }

    @media (min-width: 781px) {
      .hero .heading-xl { font-size: clamp(28.8px, 4.32vw, 52.8px); }
    }
</style>
