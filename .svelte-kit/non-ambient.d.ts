...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin-dashboard" | "/admin" | "/admin/course-editor" | "/api" | "/api/admin" | "/api/admin/users" | "/course" | "/login" | "/manage-users" | "/profile" | "/reset-password";
		RouteParams(): {
		...
		Pathname(): "/" | "/admin-dashboard" | "/admin-dashboard/" | "/admin" | "/admin/" | "/admin/course-editor" | "/admin/course-editor/" | "/api" | "/api/" | "/api/admin" | "/api/admin/" | "/api/admin/users" | "/api/admin/users/" | "/course" | "/course/" | "/login" | "/login/" | "/manage-users" | "/manage-users/" | "/profile" | "/profile/" | "/reset-password" | "/reset-password/";
