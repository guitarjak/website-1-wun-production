	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/auth/signout/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/course/lesson-content/_lessonId_/_server.ts.js'))
			},
			{
				id: "/course",
				pattern: /^\/course\/?$/,
