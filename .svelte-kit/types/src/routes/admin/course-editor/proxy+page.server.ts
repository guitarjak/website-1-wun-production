...
export const load = async ({ locals, url, setHeaders }: Parameters<PageServerLoad>[0]) => {
...
export const actions = {
  ...
  updateCourse: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  createModule: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  updateModule: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  deleteModule: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  reorderModules: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  createLesson: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  deleteLesson: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  togglePublish: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  duplicateLesson: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
  ...
  reorderLessons: async ({ request, locals }: import('./$types').RequestEvent) => {
    if (!locals.session) {
      throw redirect(303, '/login');
    }
